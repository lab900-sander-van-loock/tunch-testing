...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../beer.test-samples';

import { BeerService } from './beer.service';

const requireRestSample: IBeer = {
...
describe('Beer Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Beer', () => {
      ...
      const beer = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(beer).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Beer', () => {
      const beer = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(beer).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addBeerToCollectionIfMissing', () => {
      it('should add a Beer to an empty array', () => {
        const beer: IBeer = sampleWithRequiredData;
      ...
      it("should add a Beer to an array that doesn't contain it", () => {
        const beer: IBeer = sampleWithRequiredData;
        const beerCollection: IBeer[] = [sampleWithPartialData];
        expectedResult = service.addBeerToCollectionIfMissing(beerCollection, beer);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(beer);
      });
      ...
      it('should add only unique Beer to an array', () => {
        const beerArray: IBeer[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const beerCollection: IBeer[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const beer: IBeer = sampleWithRequiredData;
        const beer2: IBeer = sampleWithPartialData;
    ...
    describe('compareBeer', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareBeer(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareBeer(entity1, entity2);
        const compareResult2 = service.compareBeer(entity2, entity1);
