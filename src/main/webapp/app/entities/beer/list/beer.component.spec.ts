...
describe('Beer Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'beer', component: BeerComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to beerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBeerIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBeerIdentifier).toHaveBeenCalledWith(entity);
